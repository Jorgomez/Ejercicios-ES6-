...
const mutations = [
  ...
  },
  {
    ...
    description: 'Invoca a unseñor mayor como Personal Trainer'
  }
]

const alienCucu = aliens.find((alien) => alien.name === 'Cucushumushu')
const alienMuta = mutations.find((mutation) => mutation.name === 'Porompompero')

// console.log(alienCucu, alienMuta)

const fusion = { ...alienCucu, mutacion: alienMuta }
console.log(fusion.mutacion)
